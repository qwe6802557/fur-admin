    ...
    <div class="product-content">
      <el-card class="box-card">
        <div slot="header" class="clearfix">
          <i class="line"></i>
          <h2>配件列表<span v-if="showFlag">---子列表</span></h2>
          <span v-if="showFlag" class="arrow-back" @click="showFlag = !showFlag"><i class="el-icon-back"></i>返回</span>
        </div>
        <transition name="el-fade-in-linear" mode="out-in">
        <div class="product-material" v-if="!showFlag">
...
<script>
  ...
  import DetailList from '@/views/material/detail/list'
  export default {
        name: "material",
        data(){
          return {
