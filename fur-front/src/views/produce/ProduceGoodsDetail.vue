  ...
  <div id="detail-form">
    ...
    <div class="container">
      <div class="conform-words">
        ...
        <a-button type="link" icon="arrow-left"@click="$router.go(-1)">返回产品计划管理</a-button>
      </div>
      <div class="description">
        <a-descriptions layout="vertical" bordered>
          <a-descriptions-item label="生产编号">{{$route.query.produce.id}}</a-descriptions-item>
          <a-descriptions-item label="产品名称">{{$route.query.produce['good.goods_name']}}</a-descriptions-item>
          ...
          <a-descriptions-item label="生产状态" :span="3">
            <a-badge :status="$route.query.produce['goods_status.status_name'] === '已完成'? 'success' : 'processing'" :text="$route.query.produce['goods_status.status_name']" />
          </a-descriptions-item>
  ...
  export default {
    ...
    methods: {
      ...
      qrCode () {
        ...
        -----产品名称:${this.$route.query.produce['good.goods_name']}------生产状态:${this.$route.query.produce['goods_status.status_name']}`
        new QRCode('picCode', {
          width: 250,
          height: 250,        // 高度
          text:  htmlStr,   // 二维码内容
